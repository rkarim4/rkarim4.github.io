...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLScF3GT38fvPET5gNU3JnKmGAqmB8A62cA_lYUjVQBMawrWaFQ";
  var data = {
    "entry.1550055787": uid,
    "entry.1159928138": time,
    "entry.511504023": name,
    "entry.1484877909": target,
    "entry.505906221": info,
    "entry.1196944387": state,
    "entry.491585897": version
  };
  var params = [];
  for (key in data) {
